...
export const KEYWORDS: Readonly<Record<string, TokenType>> = {
  ...
  leer: TokenType.Leer,
  secuencia: TokenType.Secuencia,
  arrancar: TokenType.Arrancar,
  crear: TokenType.Crear,
  avanzar: TokenType.Avanzar,
  findesecuencia: TokenType.FinDeSecuencia,
  fds: TokenType.FinDeSecuencia,
  nofindesecuencia: TokenType.NoFinDeSecuencia,
  nfds: TokenType.NoFinDeSecuencia,
  cerrar: TokenType.Cerrar,
